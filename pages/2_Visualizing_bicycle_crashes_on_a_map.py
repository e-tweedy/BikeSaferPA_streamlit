...
st.markdown('This tool provides interactive maps showing crash events involving cyclists in PA, either statewide or in one of the more populous counties.  Choose a geographic locale and an animation method below.  Crash event dots are color-coded based on whether the crash involved serious cyclist injury, cyclist fatality, or neither.')
